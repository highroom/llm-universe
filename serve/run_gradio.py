...
LLM_MODEL_DICT = {
    ...
    "xinhuo": ["Spark-1.5", "Spark-2.0", "Spark-3.0"],
...
DEFAULT_DB_PATH = "./txt"
DEFAULT_PERSIST_PATH = "./vector_data_base"
AIGC_AVATAR_PATH = "./figures/aigc_avatar.png"
DATAWHALE_AVATAR_PATH = "./figures/datawhale_avatar.png"
AIGC_LOGO_PATH = "./figures/logo.png"
DATAWHALE_LOGO_PATH = "./figures/logo.png"
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            file = gr.File(
                ...
                file_types=[".txt", ".md", ".docx", ".pdf", ".mp4", ".jpg", ".jpeg", ".png", ".gif", ".bmp"],
            )
            with gr.Row():
